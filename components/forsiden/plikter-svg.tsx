...
const PlikterSvg = () => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="99" height="100">
        <defs>
            <ellipse id="a" cx="49.66" cy="49.934" rx="49.036" ry="49.434" />
        </defs>
        <g fill="none" fillRule="evenodd" transform="translate(-770 -727)">
            <path fill="#FFF" d="M0 0h1273v1967H0z" />
            <path fill="#E9E7E7" d="M0 697h1280v445H0z" />
            <rect width="317" height="296" x="660.5" y="778.5" fill="#FFF" stroke="#FFB249" strokeWidth="3" rx="8" />
            <g transform="translate(770 727)">
                <mask id="b" fill="#fff">
                    <use xlinkHref="#a" />
                </mask>
                <use fill="#FFD399" xlinkHref="#a" />
                <g mask="url(#b)">
                    <path
                        fill="#515658"
                    ...
                    />
                    <path fill="#C0C0BE" d="M39.497 28.063v5.524a2.399 2.399 0 0 1-2.387 2.41h-5.924l8.311-7.934z" />
                    <path
                        fill="#2F3237"
